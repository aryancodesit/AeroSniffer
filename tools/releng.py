...
def cmd_build(no_install=False):
    ...
    # Use compiler.cpp.extra_flags (empty by default in ESP32 core) to inject -include.
    # This avoids overriding build.extra_flags which contains critical platform
    # defines like -DESP32=ESP32 (needed by TFT_eSPI for DMA support).
