...
- **Status**: Fixed (pending hardware confirmation)
...
- **Verified**: Pending hardware flash and mode-switch test
...
- **Notes**: Not currently a functional blocker for mode-switch testing
